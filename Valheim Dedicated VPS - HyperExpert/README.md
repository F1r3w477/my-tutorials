...
- (Recommended) If you want more power (Confirmed 10 player support), get the VPS2 with 2vCPU, 4GB of RAM, 40GB storage on Pure SSD (You **MUST** configure the service to upgrade to 4GB) only $9.98 per month
